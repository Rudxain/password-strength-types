...
See [HashCat Wiki](https://hashcat.net/wiki/) for context
...
examples:
- "[correct horse battery staple](https://xkcd.com/936/)" is infinitely strong, for similar reasons as the fixed-size Brute-Force.
